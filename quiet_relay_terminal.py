...
# ---------------------------------------------------------------------------
# Bands, affinities, postures, and static data
# ---------------------------------------------------------------------------
...
AFFINITY_ORDER = ["ash", "bloom", "tide", "spark", "shade", "halo"]
AFFINITY_STRONG_VS = {
    "ash": "bloom",
    "bloom": "tide",
    "tide": "spark",
...
CHARACTER_BLUEPRINTS = {
    "vanguard": {
        ...
        "stat_profile": {"hp": "high", "guard": "high", "speed": "low", "break": "high"},
        "passive": "entering bastion or ravage restores 10% max_guard",
        "skills": ["standard_strike", "brace", "read_opening", "anchor_cleave", "ward_bell", "execution_drop"],
    },
    "duelist": {
        ...
        "stat_profile": {"hp": "medium", "guard": "medium", "speed": "high", "break": "low"},
        "passive": "first crit each turn grants 1 spotlight",
        "skills": ["standard_strike", "brace", "read_opening", "mark_lunge", "feint_circuit", "glass_reprise"],
    },
    "cantor": {
        "display_name": "Cantor",
        ...
        "stat_profile": {"hp": "medium", "guard": "medium", "speed": "medium", "break": "medium"},
        "passive": "when this unit applies a status, the lowest_guard ally gains a small barrier",
        "skills": ["standard_strike", "brace", "read_opening", "salt_psalm", "undertow_litany", "hex_burst"],
    },
    "ranger": {
        "display_name": "Ranger",
        ...
        "stat_profile": {"hp": "medium", "guard": "low", "speed": "high", "break": "medium"},
        "passive": "first attack against a revealed target gains guard (swap passive adapted for this prototype)",
        "skills": ["standard_strike", "brace", "read_opening", "pinning_round", "linebreaker_shot", "relay_beacon"],
    },
    "penitent": {
        "display_name": "Penitent",
        "role": "risk_reward_finisher",
        "weapon": "chain_blade",
        "default_affinity": "shade",
        "stat_profile": {"hp": "medium", "guard": "low", "speed": "medium", "break": "high"},
        "passive": "when below 50% hp, finishing skills gain +1 effective power band",
        "skills": ["standard_strike", "brace", "read_opening", "blood_oath", "thorn_spiral", "last_rite"],
    },
}

SKILL_DATA = {
    "standard_strike": {
        "display_name": "Standard Strike",
        "owner": "shared",
        "kind": "attack",
        "affinity": "neutral",
        "target": "single_enemy",
    ...
    "read_opening": {
        ...
        "effect_id": "read_opening",
    },
    "anchor_cleave": {
        "display_name": "Anchor Cleave",
        "owner": "vanguard",
        "kind": "attack",
        "affinity": "ash",
        "target": "single_enemy",
        ...
        "effect_id": "anchor_cleave",
    },
    "ward_bell": {
        "display_name": "Ward Bell",
        "owner": "vanguard",
        "kind": "support",
        "affinity": "halo",
        "target": "all_allies",
    ...
    "execution_drop": {
        ...
        "effect_id": "execution_drop",
    },
    "mark_lunge": {
        "display_name": "Mark Lunge",
        "owner": "duelist",
        "kind": "attack",
        "affinity": "halo",
        "target": "single_enemy",
        ...
        "output": {"damage": "medium", "break": "low"},
        "effect_id": "mark_lunge",
    },
    "feint_circuit": {
        "display_name": "Feint Circuit",
        "owner": "duelist",
        "kind": "stance",
        "affinity": "neutral",
        "target": "self",
        ...
        "output": {"damage": "none", "break": "none"},
        "effect_id": "feint_circuit",
    },
    "glass_reprise": {
        "display_name": "Glass Reprise",
        "owner": "duelist",
        "kind": "finisher",
        "affinity": "halo",
        "target": "single_enemy",
        ...
        "effect_id": "glass_reprise",
    },
    "salt_psalm": {
        "display_name": "Salt Psalm",
        "owner": "cantor",
        "kind": "spell",
        "affinity": "shade",
        "target": "single_enemy",
        ...
        "scale": {"primary": "precision", "secondary": "composure"},
        "output": {"damage": "low", "break": "low"},
        "effect_id": "salt_psalm",
    },
    "undertow_litany": {
        "display_name": "Undertow Litany",
        "owner": "cantor",
        "kind": "support",
        "affinity": "tide",
        "target": "all_allies",
        ...
        "scale": {"primary": "composure", "secondary": "precision"},
        "output": {"damage": "none", "break": "none"},
        "effect_id": "undertow_litany",
    },
    "hex_burst": {
        "display_name": "Hex Burst",
        "owner": "cantor",
        "kind": "spell",
        "affinity": "shade",
        "target": "single_enemy",
    ...
    "pinning_round": {
        ...
        "scale": {"primary": "precision", "secondary": "power"},
        "output": {"damage": "medium", "break": "low"},
        "effect_id": "pinning_round",
    },
    "linebreaker_shot": {
        "display_name": "Linebreaker Shot",
        "owner": "ranger",
        "kind": "ranged_attack",
        "affinity": "spark",
        "target": "single_enemy",
        ...
        "scale": {"primary": "power", "secondary": "precision"},
        "output": {"damage": "high", "break": "high"},
        "effect_id": "linebreaker_shot",
    },
    "relay_beacon": {
        "display_name": "Relay Beacon",
        "owner": "ranger",
        "kind": "utility",
        "affinity": "halo",
        "target": "single_enemy",
    ...
    "blood_oath": {
        ...
        "scale": {"primary": "power", "secondary": "composure"},
        "output": {"damage": "none", "break": "none"},
        "effect_id": "blood_oath",
    },
    "thorn_spiral": {
        "display_name": "Thorn Spiral",
        "owner": "penitent",
        "kind": "attack",
        "affinity": "bloom",
        "target": "single_enemy",
...
ENEMY_BLUEPRINTS = {
    "rustbound_pilgrim": {
        "display_name": "Rustbound Pilgrim",
        "tier": "normal",
        "affinity": "ash",
        "role": "slow_bruiser",
        "stat_profile": {"hp": "medium", "guard": "low", "speed": "low", "break": "medium"},
    },
    "ivy_strangler": {
        "display_name": "Ivy Strangler",
        "tier": "normal",
        "affinity": "bloom",
        "role": "controller",
        "stat_profile": {"hp": "low", "guard": "medium", "speed": "medium", "break": "low"},
    },
    "flood_acolyte": {
        "display_name": "Flood Acolyte",
        "tier": "normal",
        "affinity": "tide",
        "role": "setup_caster",
        "stat_profile": {"hp": "low", "guard": "low", "speed": "medium", "break": "low"},
    },
    "switchblade_drone": {
        "display_name": "Switchblade Drone",
        "tier": "normal",
        "affinity": "spark",
        "role": "fast_skirmisher",
        "stat_profile": {"hp": "low", "guard": "low", "speed": "high", "break": "low"},
    },
    "veil_leech": {
        "display_name": "Veil Leech",
        "tier": "normal",
        "affinity": "shade",
    ...
    "lamp_witness": {
        "display_name": "Lamp Witness",
        "tier": "normal",
        "affinity": "halo",
        "role": "support_cleanser",
        "stat_profile": {"hp": "low", "guard": "medium", "speed": "low", "break": "low"},
    },
    "toll_knight": {
        "display_name": "Toll Knight",
        "tier": "elite",
        "affinity": "ash",
        "role": "armored_tank",
        "stat_profile": {"hp": "high", "guard": "high", "speed": "low", "break": "high"},
    ...
    "root_jury": {
        "display_name": "Root Jury",
        "tier": "elite",
        "affinity": "bloom",
        "role": "defender_controller",
        "stat_profile": {"hp": "high", "guard": "medium", "speed": "low", "break": "low"},
    },
    "canal_seraph": {
        "display_name": "Canal Seraph",
        "tier": "elite",
        "affinity": "tide",
        "role": "flying_caster",
        "stat_profile": {"hp": "medium", "guard": "high", "speed": "medium", "break": "low"},
    },
    "static_chorister": {
        "display_name": "Static Chorister",
        "tier": "elite",
        "affinity": "spark",
        "role": "burst_caster",
        "stat_profile": {"hp": "medium", "guard": "low", "speed": "medium", "break": "medium"},
    },
    "archive_shade": {
        "display_name": "Archive Shade",
        "tier": "elite",
        "affinity": "shade",
        "role": "mimic",
        "stat_profile": {"hp": "medium", "guard": "medium", "speed": "medium", "break": "medium"},
    ...
    "glass_hound": {
        "display_name": "Glass Hound",
        "tier": "elite",
        "affinity": "halo",
        "role": "predator",
        "stat_profile": {"hp": "medium", "guard": "low", "speed": "high", "break": "low"},
    },
}

BOSS_BLUEPRINTS = {
    "bell_warden": {
        "display_name": "Bell Warden",
        "primary_affinity": "ash",
        "role": "boss_guard_break",
        "base_stats": {"hp": 430, "guard": 120, "break": 130, "speed": 10},
    },
    "flood_archivist": {
        "display_name": "Flood Archivist",
        "primary_affinity": "tide",
        "role": "boss_affinity_rotate",
        "base_stats": {"hp": 390, "guard": 80, "break": 110, "speed": 12},
    },
    "glass_hound_matriarch": {
        "display_name": "Glass Hound Matriarch",
        "primary_affinity": "halo",
        "role": "boss_pack_hunter",
        "base_stats": {"hp": 410, "guard": 75, "break": 100, "speed": 14},
    },
    "quiet_magistrate": {
        "display_name": "Quiet Magistrate",
        "primary_affinity": "shade",
        "role": "boss_pattern_punisher",
        "base_stats": {"hp": 400, "guard": 95, "break": 115, "speed": 13},
    },
}
...
HP_PROFILE = {"low": 90, "medium": 120, "high": 160}
GUARD_PROFILE = {"low": 28, "medium": 46, "high": 72}
BREAK_PROFILE = {"low": 42, "medium": 64, "high": 90}
SPEED_PROFILE = {"low": 8, "medium": 12, "high": 16}
...
def parse_args(argv: Optional[Sequence[str]] = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--log-file",
        default="/mnt/data/quiet_relay_last_battle_log.txt",
