...
SAVE_VERSION = 1
DEFAULT_SAVE_FILE = "/mnt/data/quiet_relay_vertical_slice_save.json"
DEFAULT_RUN_REPORT = "/mnt/data/quiet_relay_vertical_slice_last_run.txt"
DEFAULT_LOG_DIR = "/mnt/data/quiet_relay_vertical_slice_logs"
...
def render_party(campaign: CampaignState) -> None:
    ...
    for idx, player in enumerate(campaign.players, start=1):
        print(f"{idx}. {player.summary_line()}")
    print("-" * 84)
    print(
...
def render_hub(campaign: CampaignState, save_file: str) -> None:
    clear_screen()
    print("Quiet Relay: 2026 - Operations Base")
    print("-" * 84)
    print(wrap(
